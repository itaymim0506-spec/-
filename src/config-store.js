...
const DEFAULT_CONFIG = {
  ...
  privateChatPanelTitle: "Private Chat",
  privateChatPanelDescription: "Click the button, choose the person you want to invite, and ask them to invite you back. A private room opens only when both users invite each other.",
