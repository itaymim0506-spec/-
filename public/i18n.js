(() => {
  ...
  const translations = new Map(Object.entries({
    ...
    "הדאשבורד הרשמי לניהול הבוט לחם: טיקטים, אימות, הודעות ברוכים הבאים, עזרה וקרבות אדיטים.": "The official dashboard for managing Bread Bot: tickets, verification, welcome messages, help, and private chats.",
    ...
    "חדר פאנל חדר קרב": "Private Chat panel channel",
    "שלח פאנל חדר קרב עכשיו": "Send Private Chat panel now",
    "לא נשלח": "Not sent",
    "צריך לבחור חדר תקין לפאנל חדר קרב.": "Choose a valid channel for the Private Chat panel.",
    "פאנל חדר קרב נשלח לחדר שבחרת.": "Private Chat panel was sent to the selected channel.",
    "נשלח": "Sent",
  }));
  ...
  const extraTranslations = new Map(Object.entries({
    ...
    "חדר קרב": "Private Chat",
    "לחץ על הכפתור כדי להצטרף לחדר קרב. כשיהיו לפחות שני משתתפים, הבוט ישדך שניים רנדומלית ויפתח להם חדר פרטי.": "Click the button, choose the person you want to invite, and ask them to invite you back. A private room opens only when both users invite each other.",
    "פתיחת חדר קרב": "Start Private Chat",
    "טיקט חדש": "New ticket",
    ...
    "צריך לבחור חדר תקין לפאנל חדר קרב.": "Choose a valid channel for the Private Chat panel.",
    "פאנל חדר קרב נשלח לחדר שבחרת.": "The Private Chat panel was sent to the selected channel.",
